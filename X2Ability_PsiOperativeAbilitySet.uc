...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Templates.AddItem(SolaceCleanse());
...
static function X2DataTemplate Stasis()
{
	local X2AbilityTemplate                 Template;
	local X2AbilityCost_ActionPoints        ActionPointCost;
...
static function X2AbilityTemplate SolaceCleanse()
{
	local X2AbilityTemplate                     Template;
	local X2AbilityTrigger_EventListener        EventListener;
	...
	`CREATE_X2ABILITY_TEMPLATE(Template, 'SolaceCleanse');
...
static function X2AbilityTemplate VoidRiftInsanity()
{
	...
	EndDurationFXEffect = new class'X2Effect_TriggerEvent';
	EndDurationFXEffect.TriggerEventName = default.EndVoidRiftDurationFXEventName;
	EndDurationFXEffect.bApplyOnHit = true;
	EndDurationFXEffect.bApplyOnMiss = true;
	Template.AddTargetEffect(EndDurationFXEffect);
